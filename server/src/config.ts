...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'eKatilim';
  ...
  'jhipster.mail.from' = 'eKatilim@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'eKatilim API';
  'jhipster.swagger.description' = 'eKatilim API documentation';
  ...
  'eureka.instance.appname' = 'eKatilim';
  'eureka.instance.instanceId' = 'eKatilim:${random.value}';
